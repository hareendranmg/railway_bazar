							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
                                                                    <li class="active"><a href="userhome.php" class="act">Home</a></li>	
                                                                     <li class="active" align="right"><a href="userhome.php" class="act">Back</a></li>
									<!-- Mega Menu -->
									<li class="dropdown">
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                            <li><a href="userhome.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
                                   ...
                                   $sel27=  mysql_query("select * from add_product where product='$b' and price='$c' ");
                                   $r18= mysql_fetch_row($sel27);
                                   ?>
                                    <img src="product/<?php echo $r18[2] ?>"/>
                                    <?php
                                                ?>
				</div>
				...
				<h2><?php echo $b ?></h2>
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4 class="m-sing">RS <?php echo $c?><span></span></h4>
						</div>
