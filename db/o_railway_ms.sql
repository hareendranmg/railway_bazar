...
--
-- Host: localhost:3306
-- Generation Time: Jul 14, 2020 at 04:04 PM
...
CREATE TABLE `add_train` (
  `id` int NOT NULL,
  `train_number` int NOT NULL,
  `train_name` varchar(30) NOT NULL,
  `train_type` varchar(20) NOT NULL,
  `train_status` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(19, 'hari', 'dfdzfsdf', 'sdfsdfdsf', '1231-1231-2312-3123.png', '123123123123.png', 123123123123, '1231-1231-2312-3123', 0);
...
CREATE TABLE `cash_dep` (
  `id` int NOT NULL,
  `acunt_no` int NOT NULL,
  `aadar` varchar(19) NOT NULL,
  `amount` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_reg` (
  ...
  `user_ac_no` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
INSERT INTO `user_reg` (`id`, `user_name`, `user_adrs`, `user_mobno`, `user_adhar_no`, `user_ac_no`, `user_em`, `gender`, `user_dob`, `stat`, `user_dp`, `user_id`, `user_pass`, `user_type`, `status`, `dist`) VALUES
...
(13, 'hari', 'dfgsdfgds', 'dgdsfsdfs', '1231-2312-3123-1231', '123123123123', 'fdgdfg@dfgd.fgd', 'male', '2020-07-22', '10', 'hari.png', 'hari', 'hari', 'user', 1, '126');
...
--
-- Indexes for table `add_train`
--
ALTER TABLE `add_train`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cash_dep`
--
ALTER TABLE `cash_dep`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `post_complient`
--
ALTER TABLE `post_complient`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `train_mangmt`
--
ALTER TABLE `train_mangmt`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `add_train`
--
ALTER TABLE `add_train`
...
--
-- AUTO_INCREMENT for table `cash_dep`
--
ALTER TABLE `cash_dep`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `district`
  MODIFY `DistCode` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=651;

--
-- AUTO_INCREMENT for table `post_complient`
--
ALTER TABLE `post_complient`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `state`
  MODIFY `StCode` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `train_mangmt`
--
ALTER TABLE `train_mangmt`
