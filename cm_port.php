...
<div class="newproducts-w3tagile col-md-3"></div>
	<div class="newproducts-w3agile col-md-12">
            ...
            <div class="col-lg-8 col-md-8"><h1 align="center" style="color: #ec971f;">Post your Complient</h1>
            <form method="post">
                <table class="table table-responsive table-bordered">
                    <tr>
                     ...
                     <tr>
                        <td>Post your Complient </td>
                        <td><textarea cols="5" rows="5" name="cmplt" class="form-control"> </textarea></td>
                    </tr>
                      <tr>
                ...
                if(isset($_POST['fd']))
                {
                    ...
                    $shop=$_POST['shop_ns'];
                    $st=$_POST['cmplt'];
                    $ins5=  mysql_query("insert into post_complient values('','$user_name','$abt','$shop','$st')");
                }
                ?>
            </form>
            ...
            $sel=  mysql_query("select * from post_complient where user_name='$user_name'");
           if(mysql_num_rows($sel)>0)
           {
               ?>
                <table class="table table-responsive">
                    <tr>
                        <td>#</td><td>Shop</td><td>Station</td><td>Complaint</td><td></td>
                    </tr>
                <?php
                $i=0;
                while ($data=  mysql_fetch_row($sel))
            {
                    $i++;
                ?>
                    <tr>
                        <td><?php echo $i?></td><td><?php echo $data[2] ?></td><td><?php echo $data[3] ?></td><td><?php echo $data[4] ?></td>
                        <td><a href="cm_port.php?ic=<?php echo $data[0] ?>"> <span class="btn btn-warning">View Replay If Any</span></a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5">
            ...
            ?>
                ...
                <div >
                    ...
                    {
                        $ic=$_GET['ic'];
                        $selk=  mysql_query("select * from post_complient where id='$ic'");
                        if(mysql_num_rows($selk)>0)
                        
                            {
                            $sel_rp=  mysql_query("select * from rply_msg where cmp_id='$ic'");
                        while ($f=  mysql_fetch_row($sel_rp))
                        {
                            ?>
...
<div class="footer">
		...
		<div class="footer-copy">
			...
			iv class="container">
				<p>© 2017 railway. All rights reserved | Design by <a href="http://trinitytechnologies.com/">Trinity Technologies</a></p>
			</div>
		</div>
