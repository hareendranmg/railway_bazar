	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
                            <h1><a href="shopadminhome.php">Railway Bazaar</a></h1>
			</div>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
                                                                    <li class="active"><a href="shopadminhome.php" class="act">Home</a></li>	
									<!-- Mega Menu -->
                                                                        ...
                                                                        <li><a href="product_feedback.html">Feedback </a></li>
...
<!-- new -->
	<div class="newproducts-w3agile col-lg-10 col-md-10">
            <h2 style="color: #449d44; " align="center"><?php echo strtoupper($user_name); ?> Manegment portal</h2>
...
<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2017 Super Market. All rights reserved | Design by <a href="http://Trinity.com/">Trinity Technologies</a></p>
			</div>
		</div>
