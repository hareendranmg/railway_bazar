...
<!-- new -->
	<div class="newproducts-w3agile col-lg-10 col-md-10">
            <h2 style="color: #ec971f; " align="center">Complaints </h2>
             <?php
          $sel15=  mysql_query("select * from post_complient where shop='$user_name'");
                ...
                ?>
                     ...
                     <tr>
                        ...
                        <td><?php echo $r10[4]  ?></td>
                         <td><?php echo $r10[5]."\n".$r10[6]."\n". $r10[7] ?></td>
                         <td><a href="cmp_rpl.php?a=<?php echo $r10[0]; ?>"><span class="btn btn-warning">Reply</span></a></td>
                    </tr>
                    <?php
              }
              ?>
