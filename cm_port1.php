	...
	<div class="newproducts-w3agile col-md-12">
            ...
            <form method="post">
                ...
                $day= date('l');
                    ...
                    $ins5=  mysql_query("insert into post_complient values('','$user_name','$abt','$shop','$st','$date','$day','$time')");
                }
                ?>
            </form></div>
</div>
...
<div class="footer">
		...
		<div class="footer-copy">
			...
			iv class="container">
				<p>© 2017 railway. All rights reserved | Design by <a href="http://Railway bazaar.com/">Railway bazaar</a></p>
			</div>
		</div>
