...
<div style="float:left;">
	...
	<div class="newproducts-w3agile col-lg-10 col-md-10">
           <h2 style="color: #ec971f; " align="center">New Shops Request</h2>
            <?php
                ...
                while ($r2=  mysql_fetch_row($sel5))
                {
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $r2[7]; ?></td>
                            <td><img src="shop/<?php echo $r2[6]; ?>" width="100px"></td>
                            <td><a href="shop_aproval.php?a=<?php echo $r2[1]; ?>">Approve</a>/<a href="shop_aproval.php?b=<?php echo $r2[1]; ?>">Denay</a></td>
            ...
            <h2 style="color: #ec971f; " align="center">Approved Shops</h2>
            <?php
            $sel5=mysql_query("select * from shop_reg where type='shop' and status=1");
            if(mysql_num_rows($sel5)>0)
            {
                ?>
            ...
            $l=0;
                while ($r2=  mysql_fetch_row($sel5))
                {
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $r2[7]; ?></td>
                            <td><img src="shop/<?php echo $r2[6]; ?>" width="100px"></td>
                            <td><a href="shop_aproval.php?b=<?php echo $r2[1]; ?>">Denay</a></td>
                ...
                echo "No Approved registrations";
            }
            ?>
            
            <h2 style="color: #ec971f; " align="center">Denied Shops</h2>
            <?php
            $sel5=mysql_query("select * from shop_reg where type='shop' and status=2");
            if(mysql_num_rows($sel5)>0)
            {
                ?>
                ...
                while ($r2=  mysql_fetch_row($sel5))
                {
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $r2[7]; ?></td>
                            <td><img src="shop/<?php echo $r2[6]; ?>" width="100px"></td>
                            <td><a href="shop_aproval.php?a=<?php echo $r2[1]; ?>">Approve</a></td>
