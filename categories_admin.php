    ...
    <?php
       while ($r22=  mysql_fetch_row($sel31))
       {
         ...
         ?>
            ...
            <td> <a href="categories_admin.php?a=<?php  echo $r22[2]; ?>&e=<?php echo $station ?>"><?php  echo $r22[2]; ?><br><img style="width: 200px;height: 150px" src="shop_logo/<?php echo $r22[3]?>" class="img img-responsive img-thumbnail" />
        ...
        if(isset($_GET['e']))
   {
       ...
       if(mysql_num_rows($sel32)>0)
       {
           while ($r23=  mysql_fetch_row($sel32))
           {
               ...
               ?>
    <li>
      <a href="categories_admin.php?b=<?php  echo $r23[2]; ?>&c=<?php  echo $r23[5]; ?>&d=<?php  echo $r23[1]; ?>"><?php echo $r23[2] ?></a>
    </li>
