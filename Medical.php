...
<!--banner-bottom-->
    ...
    ?>	
		<?php
                $sel17=  mysql_query("select * from add_product where type='medical shop'");
                if(mysql_num_rows($sel17)>0)
                {
                    while ($r3=  mysql_fetch_row($sel17))
                    {
                       ?>
