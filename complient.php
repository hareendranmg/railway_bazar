...
<body>
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="manege_station.php">Manage station</a></li>
                        <li><a href="shop_aproval.php">Shops </a></li>
                        <li><a href="user_aproval.php">User List</a></li>
                        <li><a href="products.php">Products </a></li>
                        <li><a href="complient.php">Compliants </a></li>
    ...
    <div class="newproducts-w3agile col-lg-10 col-md-10">
        <h2 style="color:#ec971f; " align="center">Complients</h2>
        <div>
            <?php
echo "jithin";
$sel15 = mysql_query("select * from post_complient");
    ...
    ?>
            <table class="table table-responsive table-bordered table-striped table-condensed table-hover">
                <tr>
                    ...
                    <td>Complainted shop</td>
                    <td>shop station</td>
                    <td>compliant</td>
                    <td>Complainted On</td>
                </tr>
                <?php
$i = 0;
...
?>
    ...
    <div class="footer-copy">
        ...
        <div class="container">
            <p>© 2017 railway bazar. All rights reserved | Design by <a href="http://trinitytechnologies.com/">Trinity
                    Technologies</a></p>
        </div>
    </div>
