...
<div class="col-lg-3 col-md-3">
          <form method="post" enctype="multipart/form-data">
              <h1 style="color: #ed9c28">shop category</h1>
...
<div class="col-lg-5 col-md-5">
    <h2 align="center" style="color: #ed9c28;">Registered categories</h2>
    <?php
...
<div class="footer-copy">
				...
				<div class="container">
				<p>© 2017 railway bazar. All rights reserved | Design by <a href="http://railway_bazaar.com/">Railway Bazaar</a></p>
			</div>
		</div>	
